...
void    Bureaucrat::signForm(AForm &form)
{
    if (form.getIsSigned())
    {
        ...
        std::cout << " beacuse it's already sign." << std::endl; 
    }
    else
    {
...
void    Bureaucrat::executeForm(AForm const &form)
{
    if (form.getIsSigned())
    {
        ...
        std::cout << "Form can't be execute the bureaucrat grade is to low." << std::endl;
    }
    else
        std::cout << "Form is not sign so can't be execute." << std::endl;
    return ;
}
